...
const PERSONAS: Persona[] = [
  {
    ...
    background: 'Ivanka worked 35 years as a primary school teacher in Plovdiv. She lives on a pension of 680 BGN/month, rents out a room to cover utilities, and worries constantly about inflation eroding her savings.',
...
Keep responses to 3-5 sentences. Never break character.`,
  },
  {
    ...
    background: 'Georgi built his construction firm from scratch over 15 years. With 65 employees, Article 2 directly hits him. He operates on thin margins in a competitive sector and fears the levy will force layoffs.',
...
Keep responses to 3-5 sentences. Never break character.`,
  },
  {
    ...
    background: 'Nikola works remotely for EU clients. He earns well but resents being penalised for not being an employee. Article 3 raises his monthly minimum contribution by 317 BGN, which he finds arbitrary.',
...
function aggregateMetrics(metrics: CallMetrics[], model: 'gpt-5' | 'gemini-2.5-flash'): CallMetrics {
...
async function main() {
  ...
  console.log(`Total cost for 3-persona round - GPT-5: $${totalGpt.toFixed(6)}, Gemini: $${totalGemini.toFixed(6)}`);
